...
def add_incident(request):
	if request.method == "POST":
		...
		if form.is_valid() and (("chier" or "connard" or "bite" or "chatte" or "cul") not in form['reason'].data) and (("sitedemerde@degage.fr" or "connard.fr") not in form['contributors']) :
			form.save()
